// VoteMap API client — curated candidate data
// All data is served directly from in-memory mock data.

import { useDataSourceStore } from '@/stores/useDataSourceStore'
const setCandSource = (s: 'live' | 'demo' | 'loading' | 'cached') => useDataSourceStore.getState().setSource('candidates', s)
